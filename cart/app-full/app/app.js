...
var cart = angular.module('myApp', ['ngAnimate']);
cart.config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider)
{
    $routeProvider
    .when("/cart", {
...
cart.controller('myController', function ($scope) {
